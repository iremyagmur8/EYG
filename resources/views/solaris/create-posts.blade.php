...
@section('modulecontent')
    ...
    <div class="portlet-box">
        <div class="portlet-header flex-row flex d-flex align-items-center">
            <a href="/solaris/add/posts" class="btn btn-rounded btn-primary btn-sm m-r-5">Formu
                Sıfırla</a>
            ...
            <div class="col-md-12">
                    ...
                    <div class="form-row">
                        ...
                        <div class="form-group col-md-3">
                            <label for="title">İçerik Kategorisi</label>
                            <select class="form-control" name="category" id="ustKategori">
                                <option value="0"
                                        @if(!empty($cData->data) && $cData->data->category_id == 0) selected @endif>
                                    Lütfen Seçin
                                </option>
                    ...
                    <div class="form-row">
                        ...
                        <div class="form-group col-md-2">
                            ...
                            <select class="form-control" name="theme" id="theme">
                                ...
                                <option value="1"  @if(!empty($cData->data) && $cData->data->theme == 1) selected @endif>Tema 1</option>
                                <option value="2" @if(!empty($cData->data) && $cData->data->theme == 2) selected @endif>Tema 2</option>
                                <option value="3" @if(!empty($cData->data) && $cData->data->theme == 3) selected @endif>Tema 3</option>
                                <option value="4" @if(!empty($cData->data) && $cData->data->theme == 4) selected @endif>Tema 4</option>
                                <option value="5" @if(!empty($cData->data) && $cData->data->theme == 5) selected @endif>Tema 5</option>
                            </select>
                        </div>
